...
export default function Header() {
    return (
        <header className="sticky top-0 z-50 flex-grow-0 p-6 border-b-2 border-base-100 bg-base-50/50 ">
            <div className="max-w-2xl mx-auto flex gap-2 justify-between">
                <NavLink className="text-lg uppercase font-title font-black text-base-600 py-2" to="/">Remix Starter</NavLink>
                <Nav>
